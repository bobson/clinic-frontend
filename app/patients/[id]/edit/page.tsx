...
import { GET_PATIENT, UPDATE_PATIENT, GET_PATIENTS } from "@/graphql/";
...
export default function EditPatientPage() {
  ...
  const onFinish = async (values: any) => {
    try {
      await updatePatient({ variables: { id, ...values } });
  ...
  return (
    <div className="p-4 bg-gray-50 min-h-screen">
      <div className="max-w-2xl mx-auto">
        <Card
          title={<span className="text-xl font-semibold">Edit Patient</span>}
